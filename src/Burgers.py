...
class Net(nn.Module):
    def __init__(self):
        ...
        # TODO: specify the layers and nodes of the Burgers PINN
    ...
    def forward(self, x):
        ...
        # TODO: specify the activation function(s) for the hidden and output layers of the Burgers PINN
...
def lossfunction(u_ICBC_NN, u_ICBC, u_F, ut_F, ux_F, uxx_F):
    ...
    # TODO: compute MSE_ICBC and MSE_F
...
def train_model(path="./burgers_shock.mat"):
    ...
    # I didn't like this plot, so I excluded it, if you want you can comment it back in
