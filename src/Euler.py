...
class Net(nn.Module):
    def __init__(self):
        ...
        # TODO: specify the layers and nodes of the 1D Euler PINN
    ...
    def forward(self, x):
        ...
        # TODO: specify the activation function(s) for the hidden and output layers of the 1D Euler PINN
...
def lossfunction(F_grads, nabla_rho_tensors, probe_tensors, mass0_tensors):
    ...
    # these weights are also hyperparameters that you can change
    w_nabla_rho = 1
    w_probe = 1
    w_mass0 = 1
    w_F = 1
    ...
    # TODO: compute MSE_F, MSE_nabla_rho, MSE_probe and MSE_mass0
